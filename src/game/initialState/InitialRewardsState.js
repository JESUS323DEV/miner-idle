const InitialRewardsState = {
    ...
    fragmentRewards: {
        ...
        set2IronMine:    { claimed: false, unlocked: false, visible: false, group: 'set2', dogs: [{ dogId: 'chihuahua', isForge: false, amount: 100 }, { dogId: 'rex', isForge: true, amount: 100 }], label: 'Desbloquea la mina de bronce' },
        set2Iron300:     { claimed: false, unlocked: false, visible: false, group: 'set2', dogs: [{ dogId: 'boxer', isForge: false, amount: 200 }, { dogId: 'pip', isForge: true, amount: 200 }], label: 'Obtén 300 de bronce en la mina' },
        set2ForgeBronze: { claimed: false, unlocked: false, visible: false, group: 'set2', randomFragments: [{ rarity: 'rare', amount: 15, isForge: true }, { rarity: 'epic', amount: 10, isForge: true }, { rarity: 'legendary', amount: 5, isForge: true }], label: 'Desbloquea el horno de bronce' },
        set2Smelt50:     { claimed: false, unlocked: false, visible: false, group: 'set2', randomFragments: [{ rarity: 'rare', amount: 15, isForge: true }, { rarity: 'epic', amount: 10, isForge: true }, { rarity: 'legendary', amount: 5, isForge: true }], label: 'Funde 50 lingotes de bronce' },
