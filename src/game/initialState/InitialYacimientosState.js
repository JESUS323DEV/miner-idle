const InitialYacimientosState = {
    ...
    iron: {
        ...
        slotConfig: {
            ...
            2: { maxDurability: 35, repairCost: 1500, upgradeCost: 40, growthTime: 120, repairCooldown: 60 },
        }
    },
    ...
    diamond: {
        ...
        slotConfig: {
            1: { maxDurability: 20, repairCost: 1000, upgradeCost: 20, growthTime: 80, repairCooldown: 30 },
            2: { maxDurability: 40, repairCost: 1500, upgradeCost: 40, growthTime: 160, repairCooldown: 60 },
        }
    },
};
