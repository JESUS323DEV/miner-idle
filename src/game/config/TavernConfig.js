export const TavernConfig = {
    ...
    coinToGold: 5000,
    provisionsMaxStock: 15,
    stockUpgrades: [
        { to: 20, cost: 15000,   coins: 2  },
        { to: 25, cost: 25000,   coins: 15 },
        { to: 30, cost: 75000,   coins: 20 },
        { to: 35, cost: 100000,  coins: 30 },
    ],
    createdMaxStock: 10,
    createdStockUpgrades: [
        { to: 15, gold: 20000,  coins: 3  },
        { to: 20, gold: 30000,  coins: 15 },
        { to: 25, gold: 45000,  coins: 25 },
        { to: 30, gold: 85000,  coins: 35 },
        { to: 35, gold: 120000, coins: 40 },
    ],
