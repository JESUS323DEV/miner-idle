export const PJ_MISSION_TEMPLATES = {
    rare: {
        missions: [
            ...
            { missionId: 'passive_raids', label: 'Mándalo en 3 raids pasivas', type: 'passiveRaids', target: 3 },
        ],
        missionReward: 20,
        finalReward: 150,
    },
    epic: {
        missions: [
            ...
            { missionId: 'passive_raids', label: 'Mándalo en 6 raids pasivas', type: 'passiveRaids', target: 6 },
        ],
        missionReward: 20,
        finalReward: 150,
    },
    legendary: {
        missions: [
            ...
            { missionId: 'passive_raids', label: 'Mándalo en 10 raids pasivas', type: 'passiveRaids', target: 10 },
