export const DAILY_QUESTS_FIXED = [
    { id: 'mine_gold_1',     label: 'Mina 500 de oro',                   target: 500,  type: 'goldMined',      reward: { coins: 1 } },
    { id: 'repair_10',       label: 'Repara 10 veces',                   target: 10,   type: 'repairs',        reward: { coins: 1 } },
    ...
    { id: 'passive_send_1',  label: 'Envía 1 raid pasiva',               target: 1,    type: 'passiveSent',    reward: { coins: 2 } },
    { id: 'active_win_1',    label: 'Gana una raid activa',              target: 1,    type: 'activeWins',     reward: { coins: 3 } },
    ...
    { id: 'passive_claim_1', label: 'Reclama 1 raid pasiva',             target: 1,    type: 'passiveClaimed', reward: { coins: 2 } },
];
...
export const DAILY_QUESTS_EXTRA_20 = [
    ...
    { id: 'passive_3',       label: 'Ten 3 raids pasivas activas',       target: 3,    type: 'passiveActive',  reward: { coins: 3 } },
    ...
    { id: 'active_fast',     label: 'Completa una raid activa',          target: 1,    type: 'activeWins',     reward: { coins: 2 } },
    { id: 'active_ability',  label: 'Usa una habilidad en raid activa',  target: 1,    type: 'abilityUses',    reward: { coins: 2 } },
    { id: 'active_3',        label: 'Gana 3 raids activas',              target: 3,    type: 'activeWins',     reward: { coins: 5 } },
