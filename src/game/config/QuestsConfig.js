...
export const DAILY_QUESTS_DAY4 = [
    ...
    { id: 'burst_20',          label: 'Usa el burst 20 veces',             target: 20,    type: 'burstUses',      reward: { coins: 2 } },
    { id: 'combo_20',          label: 'Llega a combo 35',                  target: 35,    type: 'maxCombo',       reward: { coins: 7 } },
    { id: 'passive_send_2',    label: 'Envía 7 expediciones',              target: 7,     type: 'passiveSent',    reward: { coins: 8 } },
    { id: 'dog_assign_2',      label: 'Asigna 3 perros a la mina',         target: 3,     type: 'dogsAssigned',   reward: { coins: 4 } },
    { id: 'passive_claim_2',   label: 'Reclama 2 expediciones',            target: 2,     type: 'passiveClaimed', reward: { coins: 4 } },
    { id: 'mine_gold_20k',     label: 'Mina 20000 de oro',                 target: 20000, type: 'goldMined',      reward: { coins: 8 } },
];

export const DAILY_QUESTS_DAY5 = [
    { id: 'combo_50',          label: 'Llega a combo 50',                  target: 50,    type: 'maxCombo',       reward: { coins: 15 } },
    { id: 'repair_40',         label: 'Repara 40 veces',                   target: 40,    type: 'repairs',        reward: { coins: 4 } },
    { id: 'passive_send_10',   label: 'Envía 10 expediciones',             target: 10,    type: 'passiveSent',    reward: { coins: 8 } },
    { id: 'mine_entries_6_d2', label: 'Entra en cualquier mina 6 veces',   target: 6,     type: 'mineEntries',    reward: { coins: 4 } },
    { id: 'mine_gold_30k',     label: 'Mina 30000 de oro',                 target: 30000, type: 'goldMined',      reward: { coins: 7 } },
    { id: 'passive_team3_5x',  label: 'Envía equipo de 3 perros a una expedición 5 veces', target: 5, type: 'passiveTeam3', reward: { coins: 8 } },
    { id: 'combo_60',          label: 'Llega a combo 60',                  target: 60,    type: 'maxCombo',       reward: { coins: 20 } },
    { id: 'passive_shards_2',  label: 'Consigue shards en 5 expediciones', target: 5,     type: 'passiveShards',  reward: { coins: 8 } },
