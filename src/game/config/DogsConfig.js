...
export const DogsConfig = {
    ...
    chihuahua: {
        ...
        id: 'chihuahua',
        name: 'Chihuahua',
        unlockCost: { gold: 50000, tavernCoins: 10 },
        starBonus: 0.15,
        unlockFragments: 100,
    ...
    tuka: {
        ...
        id: 'tuka',
        name: 'Tuka',
        unlockCost: { gold: 500000, tavernCoins: 100 },
        starBonus: 0.20,
        unlockFragments: 150,
    ...
    muna: {
        ...
        id: 'muna',
        name: 'Muna',
        unlockCost: { gold: 200000, tavernCoins: 40 },
        starBonus: 0.20,
        unlockFragments: 150,
        starFragments: [200, 400, 600, 800, 1000],
        yacimientoYield: 7,
    ...
    lady: {
        ...
        id: 'lady',
        name: 'Lady',
        unlockCost: { gold: 600000, tavernCoins: 150 },
        starBonus: 0.20,
        unlockFragments: 150,
        starFragments: [200, 400, 600, 800, 1000],
        yacimientoYield: 8,
 ...
 //TOKIO LEGENDARIA PARA MINA DE BRONZE
    ...
    smoke: {
        ...
        id: 'smoke',
        name: 'Smoke',
        unlockCost: { gold: 75000, tavernCoins: 30 },
        starBonus: 0.15,
        unlockFragments: 100,
        starFragments: [150, 300, 450, 600, 750],
        yacimientoYield: 4,
    ...
    nupito: {
        ...
        id: 'nupito',
        name: 'Nupito',
        unlockCost: { gold: 300000, tavernCoins: 45 },
        starBonus: 0.20,
        unlockFragments: 150,
        starFragments: [200, 400, 600, 800, 1000],
        yacimientoYield: 4,
    ...
    gordo: {
        ...
        id: 'gordo',
        name: 'Gordo',
        unlockCost: { gold: 20000, tavernCoins: 5 },
        starBonus: 0.10,
        unlockFragments: 50,
        starFragments: [100, 200, 300, 400, 500],
        yacimientoYield: 2,
    ...
    zeus: {
        ...
        id: 'zeus',
        name: 'Zeus',
        unlockCost: { gold: 40000, tavernCoins: 8 },
        starBonus: 0.10,
        unlockFragments: 50,
        starFragments: [100, 200, 300, 400, 500],
        yacimientoYield: 2,
