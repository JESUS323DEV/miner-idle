...
const STEPS = {
    ...
    automine_recharge_hint: {
        title: "Recarga tu autominado",
        text: "Toca el icono de recarga para recuperar 2 cargas de autominado al instante.",
        action: null,
        counter: null,
        showSkip: false,
    },
    automine_hint: {
        title: "El Autominado",
        text: "Golpea solo durante unos segundos. Tiene 2 cargas que se recargan con el tiempo. Puedes mejorar el tiempo de recarga desde la pantalla del pico. ¡Úsalo siempre que puedas!",
        action: null,
        counter: null,
        showSkip: false,
    },
